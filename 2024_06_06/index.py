...
class Window(ThemedTk):
    def __init__(self,**kwargs):
        ...
        # style.configure('Top.TLabel',background='#BEC23F',font=('Helvetica',25,'bold'))
    ...
    def download_parse_data(self)->list[dict] | None:
        try:
            ...
            messagebox.showwarning("出現錯誤","出現小錯誤，請稍後在試!")
            return
        else:        
...
class ShowInfo(Dialog):
    def __init__(self,parent:Misc,title:str|None = None,message:str=""):
        ...
        super().__init__(parent=parent,title=title) #最後才執行，__init__()方法，這個方法可能需要某些屬性或變數在初始化時就被設置好 
